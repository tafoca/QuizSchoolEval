    ...
    <body>
        <div id="art-main">
            <header class="art-header">
                ...
                <h2 class="art-slogan" data-left="71.17%">Administrateur : ${profilConnecteur.enseignant.nomenseignant}</h2>
                        ...
                        <div class="art-content-layout-row">
                            ...
                            <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <div class="art-postcontent art-postcontent-0 clearfix">
									...
									<f:form modelAttribute="ajoutEtudiant" method="post"
												action="ajoutEtudiantE">

												<fieldset class="input" style="border: 0 none;">
														<p> Les champs avec  le symbole <span class="obligatoire">*</span> devant sont obligatoires ....</p>			
													<table border="5" style="width: 100%">
														<caption>AJOUT D'UN ETUDIANT <span class="obligatoireGreen">${ajoutEtudiant.reponse}</span></caption>
														<tr>
														...
														<tr>
															...
															<td><f:input path="datenaissance" class="inputbox"
																	style="width:100%" /> <f:errors path="datenaissance"></f:errors>
															</td>
															<td>
																<p id="form-login-username">
														...
														<tr>
															...
															<td>
															<f:password path="motpasse" style="width:100%;"/>
															</td>
															<td>
															<p id="form-login-username">
																	<label for="modlgn_username">Matricule <span class="obligatoire">*</span></label><br />
																</p> 
															</td>
															<td>
															<f:input path="matricule" class="inputbox" style="width:100%;"/>
															</td>
														...
														<td>
														<p id="form-login-username">
																	<label for="modlgn_username">Code Filiere <span class="obligatoire">*</span></label><br />
																</p> 
														</td>
														<td>
														<f:input path="filiere" class="inputbox" style="width:100%;"/>
                                        ...
                                        <p>
														<table border="5" style="width: 100%"> 
														<tr> <td> Ajouter un Enseignant Ici </td><td> <f:form modelAttribute="ajoutEnseignant" method="post" action="ajoutE"><input type="submit" value="Ajouter Enseignant"/></f:form></td>        </tr>
